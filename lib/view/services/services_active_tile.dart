        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(service.image, maxLines: 1, overflow: TextOverflow.ellipsis, style: theme.textTheme.bodySmall?.copyWith(color: theme.colorScheme.onSurface.withValues(alpha: 0.7))),
                  ],
                ),
              ),
              if (mountRoot != null && mountRoot!.trim().isNotEmpty) ...[
                IconButton(tooltip: 'Open data folder', onPressed: () => _openDirectory(context, mountRoot!), icon: const Icon(Icons.folder_open_rounded)),
          ...
          Wrap(
            ...
            children: [
              ...
              _ActionChip(label: service.lanEnabled ? 'LAN On' : 'LAN Off', icon: Icons.wifi_tethering_rounded, onTap: () => bloc.add(MainExposeLanRequested(id: service.id, enabled: !service.lanEnabled))),
          ...
          if (liveMetrics != null) ...[
            Wrap(
              ...
              children: [
                ...
                _ServiceMeta(label: 'RAM', value: liveMetrics!.memoryLimitBytes > 0 ? '${_formatBytes(liveMetrics!.memoryUsageBytes)} / ${_formatBytes(liveMetrics!.memoryLimitBytes)}' : _formatBytes(liveMetrics!.memoryUsageBytes)),
