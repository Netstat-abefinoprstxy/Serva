...
extension _ServiceDetailsSheetSections on _ServiceDetailsSheetState {
  ...
  List<Widget> _buildDetailSections(_ServiceDetailsData data) {
    return [
      _DetailSection(
        title: 'Overview',
        child: Column(
      ...
      _buildPortsSection(data),
      _buildStatsSection(data),
      _buildLogsSection(data),
      _buildEnvironmentSection(data),
      _buildMountsSection(data),
      _buildLabelsSection(data),
      const SizedBox(height: 32),
    ];
  }

  Widget _buildPortsSection(_ServiceDetailsData data) {
  ...
  Widget _buildStatsSection(_ServiceDetailsData data) {
    return _DetailSection(
      title: 'Stats',
      child: Column(
        children: [
  ...
  Widget _buildLogsSection(_ServiceDetailsData data) {
    return _DetailSection(
      title: 'Logs',
      trailing: IconButton(
        tooltip: 'Copy logs',
  ...
  Widget _buildEnvironmentSection(_ServiceDetailsData data) {
    return _DetailSection(
      title: 'Environment',
      child: data.inspect.env.isEmpty
          ? const Text('No environment variables reported.')
          : Column(
              children: data.inspect.env.map((entry) => _DetailRow(label: 'ENV', value: entry)).toList(),
            ),
    );
  }

  Widget _buildMountsSection(_ServiceDetailsData data) {
    return _DetailSection(
      title: 'Mounts',
  ...
  Widget _buildLabelsSection(_ServiceDetailsData data) {
    return _DetailSection(
      title: 'Labels',
